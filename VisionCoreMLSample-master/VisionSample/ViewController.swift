...
class ViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
  ...
  override func viewDidLoad() {
    ...
    guard let resNet50Model = try? VNCoreMLModel(for: coke().model) else {
  ...
  func handleClassifications(request: VNRequest, error: Error?) {
    ...
    if (topPredictionScore != nil && topPredictionScore! > 0.8) {
        if (topPredictionName == "coke") {
            self.imageView.image = #imageLiteral(resourceName: "coke")
        }
        if (topPredictionName == "fresca") {
            self.imageView.image = #imageLiteral(resourceName: "fresca")
        }
        if (topPredictionName == "fanta") {
            self.imageView.image = #imageLiteral(resourceName: "fanta")
        }
        if (topPredictionName == "none") {
            self.imageView.image = #imageLiteral(resourceName: "q")
        }
    }
